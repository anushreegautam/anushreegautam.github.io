    ...
    <section className="projects-container" id="projects">
      <div>
        ...
        <div>
          ...
          <br/>
          <ul>
            <li>TODO is a responsive single page web application which allows users to <strong>create an account, reset password through email</strong> and <strong>add, update, reorder, filter and delete tasks.</strong></li>
            <li>The application is built using <strong>MERN stack.</strong></li>
            <li><strong>Json web tokens with RSA signatures</strong> are used for <strong>user authentication</strong> and verifying link for <strong>password reset.</strong></li>
          </ul>
          <br/>
          <div className="flex-container-row">
